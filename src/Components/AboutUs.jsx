export function About() {
    return (
        <div>
            <div className="bg-gradient-to-r from-Purpple to-blue-500">
                <h2 className="font-Poppins text-7xl font-extralight pt-3 pb-3 text-white animate-Move position-relative ">We're here to change your daily lifestyle</h2>
            </div>
