...
function Offer(){
    return (
        ...
        Mobile-M:w-full Mobile-M:flex-col Mobile-M:justify-center Mobile-M:items-center Mobile-M:p-3 Mobile-M:gap-2
        Mobile-L:w-full Mobile-L:flex-col Mobile-L:justify-center Mobile-L:items-center Mobile-L:p-3 Mobile-L:gap-3">
            <h3 className="font-Poppins font-medium text-white Mobile-S:text-sm">Get flat 20% offer on every service</h3>
